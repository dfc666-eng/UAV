...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if step == 0:#起飞
            ...
            send_pose(pose)
            #rospy.loginfo(pos_data.pose)
            if reach_pose(10,0,init_alt+4,0.1) and not reach_drop_point:
            ...
            send_pose(pose)
            #rospy.loginfo(pos_data.pose)
            if reach_pose(20,0,init_alt+4,0.1):
                step=3
            ...
            send_pose(pose)
            #rospy.loginfo(pos_data.pose)
            if reach_pose(20,-2,init_alt+4,0.1):
                step=4
            ...
            send_pose(pose)
            #rospy.loginfo(pos_data.pose)
            if reach_pose(25,-2,init_alt+4,0.1):
                step=5
