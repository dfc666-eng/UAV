...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        if step == 0:#起飞
                ...
                while not drop:
                    ...
                    try:
                        if (rospy.Time.now() - last_req) > rospy.Duration(3.0):#每隔一段时间进行一次校准
                            ...
                            rot_xy=[init_x+cam_dist+bucket_pos.y,init_y+bucket_pos.x]#对准桶
                            world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
            ...
            i=0
            while i<=3:
                rot_xy=[init_x+51,init_y+i]#(51,3)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=4:
                rot_xy=[init_x+51+i,init_y+3]#(55,3)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=6:
                rot_xy=[init_x+55,init_y+3-i]#(55,-3)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=4:
                rot_xy=[init_x+55-i,init_y-3]#(51,-3)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=3:
                rot_xy=[init_x+51,init_y-3+i]#(51,0)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=2:
                rot_xy=[init_x+51+i,init_y+0]#(53,0,2.5)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
                pose.pose.position.z = init_alt+2.5
            ...
            i=0
            while i<=3:
                rot_xy=[init_x+53,init_y+0]#(53,0,5.5)
                world_xy=[rot_xy[0]*math.cos(init_yaw)-rot_xy[1]*math.sin(init_yaw), rot_xy[0]*math.sin(init_yaw)+rot_xy[1]*math.cos(init_yaw)]
                pose.pose.position.x = world_xy[0]
                pose.pose.position.y = world_xy[1]
