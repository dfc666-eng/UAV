...
def set_orientation(yaw):
    temp_pose=PoseStamped()
    roll=Quaternion_Euler_Transform(pos_data.pose.orientation)[0]
    pitch=Quaternion_Euler_Transform(pos_data.pose.orientation)[1]
    temp_pose.pose.orientation=Euler_Quaternion_Transform([roll,pitch,yaw])
    return temp_pose.pose.orientation
...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        pose.pose.orientation=set_orientation(init_yaw)
